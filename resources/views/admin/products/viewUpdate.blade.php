    ...
    <div class="col-lg-6 offset-3">
        <div class="card">
            <div class="card-body">
                ...
                <hr>
                <form action="{{ route('admin.product.editPizzaData') }}" method="post" enctype="multipart/form-data" novalidate="novalidate">
                    @csrf
                    <div class="form-group">
                        ...
                        <input id="category_name" name="name" type="text"
                            ...
                            aria-invalid="false" placeholder="Category Name" value="{{ old('name') }}">
                        @error('name')
